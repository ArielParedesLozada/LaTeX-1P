...
gerentes de proyecto \cite{choudhury2020gitlab}. Esto permite una \\
...
Algunas de las principales características de GitLab se resumen en la siguiente tabla:
\begin{table}
        \centering
        \begin{tabular}{l l l l l}
                Curva de aprendizaje & Tipo de licencia & Empresa propietaria & Año de creación & Lenguaje usado & Ejemplos de uso \\
                \hline
                \hline
                Waza
        \end{tabular}
