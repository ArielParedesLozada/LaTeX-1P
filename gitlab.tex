...
\begin{itemize}
        ...
        \item \textit{RQ1-Objetivo}: Identificar las características principales de GitLab, como tipo de licencia y curva de aprendizaje
        \item \textbf{RQ2}: ¿Cuáles son las funciones de GitLab?
        \item \textit{RQ2-Objetivo}: Describir las principales funciones, casos de uso y ejemplos de aplicaciones hechas con GitLab
        \item \textbf{RQ3}: ¿Cuál es la historia de GitLab?
        \item \textit{RQ3-Objetivo}: Compilar el desarrollo de GitLab a lo largo del tiempo y contrastarlo con otras herramientas similares
        \item \textbf{RQ4}: ¿Cuáles son las ventajas y desventajas de GitLab?
        \item \textit{RQ4-Objetivo}: Examinar los pros y contras del desarrollo con GitLab frente a otras herramientas DevOps y enfoques de desarrollo
\end{itemize}
...
Se hizo una búsqueda en los sitios web de Google Scholar, Academia, IEEE Xplore e incluso PubMed Central.
...
\begin{table}[ht!]
        ...
        \end{tabular}
        \caption{Tabla de bases de datos consultadas}
        \label{table:1}
\end{table}
...
\begin{itemize}
        ...
        \item De preferencia, que sea una investigación publicada en inglés
\end{itemize}
Todos loa artículos encontrados caen dentro de estos criterios de selección.
