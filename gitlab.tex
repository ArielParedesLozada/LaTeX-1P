...
privacidad. Además, al tener control total sobre los servidores, se pueden gestionar los proyectos con mucha más libertad y de manera
más personalizada \cite{safari2020structural}.\\
También se pueden gestionar aspectos de seguridad, ya que se pueden implementar políticas propias de seguridad más estrictas. Este es
...
nombrar las ramas y gestionarlas, se sigue el flujo de trabajo de GitLab flow, descrito con anterioridad.\\
...
También se encuentra Markdown, que es capaz de generar documentación que puede versionarse y gestionarse de igual manera que el
